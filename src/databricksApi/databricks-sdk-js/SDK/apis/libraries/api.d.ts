...
export declare class LibrariesService {
     ...
     * the libraries UI.
     */
    allClusterStatuses(context?: Context): Promise<model.ListAllClusterLibraryStatusesResponse>;
     ...
     * guarantee.
     */
    clusterStatus(request: model.ClusterStatus, context?: Context): Promise<model.ClusterLibraryStatuses>;
    private _install;
    /**
     * Add a library.
     *
     ...
     */
    install(request: model.InstallLibraries, context?: Context): Promise<model.EmptyResponse>;
    private _uninstall;
    /**
     * Uninstall libraries.
     *
     ...
     */
    uninstall(request: model.UninstallLibraries, context?: Context): Promise<model.EmptyResponse>;
}
